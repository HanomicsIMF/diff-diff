...
- **Efficient staggered DiD** (Chen, Sant'Anna & Xie, arXiv:2506.17729, 2025). Extends the shipped `EfficientDiD` from 2x2 to staggered timing via the paper's closed-form efficient IF. Tractability: high. **Commit when**: paper-review synthesis and REGISTRY.md plan written.
