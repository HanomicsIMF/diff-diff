...
- SyntheticDiD bootstrap SE formula applies the `sqrt((r-1)/r)` correction matching R's synthdid and the placebo SE formula (approximately 0.25% SE change at `n_bootstrap=200`).
