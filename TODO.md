...
|-------|----------|----|----------|
| CallawaySantAnna: materialize NaN entries for non-estimable (g,t) cells per REGISTRY.md line 350; currently omitted from group_time_effects dict | `staggered.py` | #256 | Medium |
